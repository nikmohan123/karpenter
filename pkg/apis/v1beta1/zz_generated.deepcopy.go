...
func (in *NodeClaimSpec) DeepCopyInto(out *NodeClaimSpec) {
	*out = *in
	...
	if in.Requirements != nil {
		...
		*out = make([]NodeSelectorRequirementWithFlexibility, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeSelectorRequirementWithFlexibility) DeepCopyInto(out *NodeSelectorRequirementWithFlexibility) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeSelectorRequirementWithFlexibility.
func (in *NodeSelectorRequirementWithFlexibility) DeepCopy() *NodeSelectorRequirementWithFlexibility {
	if in == nil {
		return nil
	}
	out := new(NodeSelectorRequirementWithFlexibility)
	in.DeepCopyInto(out)
	return out
}
