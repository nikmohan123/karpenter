...
var _ = Describe("Requirements", func() {
	...
	Context("NodeSelectorRequirements Conversion", func() {
		...
		It("should convert combinations of labels with flexiblity to expected NodeSelectorRequirements", func() {
			...
			Expect(reqs.NodeSelectorRequirements()).To(ContainElements(
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "exists", Operator: v1.NodeSelectorOpExists}, MinValues: lo.ToPtr(3)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "doesNotExist", Operator: v1.NodeSelectorOpDoesNotExist}, MinValues: lo.ToPtr(2)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "inA", Operator: v1.NodeSelectorOpIn, Values: []string{"A"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "inB", Operator: v1.NodeSelectorOpIn, Values: []string{"B"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "inAB", Operator: v1.NodeSelectorOpIn, Values: []string{"A", "B"}}, MinValues: lo.ToPtr(2)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "notInA", Operator: v1.NodeSelectorOpNotIn, Values: []string{"A"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "in1", Operator: v1.NodeSelectorOpIn, Values: []string{"1"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "in9", Operator: v1.NodeSelectorOpIn, Values: []string{"9"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "in19", Operator: v1.NodeSelectorOpIn, Values: []string{"1", "9"}}, MinValues: lo.ToPtr(2)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "notIn12", Operator: v1.NodeSelectorOpNotIn, Values: []string{"1", "2"}}, MinValues: lo.ToPtr(2)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "greaterThan1", Operator: v1.NodeSelectorOpGt, Values: []string{"1"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "greaterThan9", Operator: v1.NodeSelectorOpGt, Values: []string{"9"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "lessThan1", Operator: v1.NodeSelectorOpLt, Values: []string{"1"}}, MinValues: lo.ToPtr(1)},
				v1beta1.NodeSelectorRequirementWithFlexibility{NodeSelectorRequirement: v1.NodeSelectorRequirement{Key: "lessThan9", Operator: v1.NodeSelectorOpLt, Values: []string{"9"}}, MinValues: lo.ToPtr(1)},
			))
			Expect(reqs.NodeSelectorRequirements()).To(HaveLen(14))
		})
	})
