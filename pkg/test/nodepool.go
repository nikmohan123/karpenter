...
func NodePool(overrides ...v1beta1.NodePool) *v1beta1.NodePool {
	...
	if override.Spec.Template.Spec.Requirements == nil {
		override.Spec.Template.Spec.Requirements = []v1beta1.NodeSelectorRequirementWithFlexibility{}
	}
	np := &v1beta1.NodePool{
...
func ReplaceRequirements(nodePool *v1beta1.NodePool, reqs ...v1beta1.NodeSelectorRequirementWithFlexibility) *v1beta1.NodePool {
	keys := sets.New[string](lo.Map(reqs, func(r v1beta1.NodeSelectorRequirementWithFlexibility, _ int) string { return r.Key })...)
	nodePool.Spec.Template.Spec.Requirements = lo.Reject(nodePool.Spec.Template.Spec.Requirements, func(r v1beta1.NodeSelectorRequirementWithFlexibility, _ int) bool {
